        ...
        <div className="flex flex-col items-center justify-center bg-gray-50 py-8 px-4">
          <ConfidenceRing
            ...
            breakdown={[
              {
                label: "Product Type",
                score: result.score_breakdown.ai_analysis?.score ?? 0,
                weight: result.score_breakdown.ai_analysis?.weight ?? 0,
                contribution: result.score_breakdown.ai_analysis?.contribution ?? 0,
              },
